...
const Chatbox: React.FC<ChatboxProps> = ({adminMessages, sendMessage, updateMessageBoxActive, supportMessage }) => {
            ...
            <div className='w-full h-[82%] px-4 py-2 bg-inherit flex flex-col space-y-2 overflow-y-auto sm:h-[385px]'>
                    <div className='w-full pt-4 flex justify-start items-center space-x-3'>
                        ...
                        <div className='flex flex-col space-y-1'>
                            {adminMessages.map((data, index) => (
                                <div key={index} className='p-4 bg-[#f5f5f5] border border-[#f5f5f5] rounded-[5px]'>
                                    <p className='text-[14px] text-black '>{data}</p>
                                </div>
                            ))}
                        </div>
                    </div>
